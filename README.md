...
- **Interactive Shopping Cart:** - Add items to the cart with real-time "Product Added" notifications.
  - Dynamic price calculations including subtotal, tax (5%), and total.
  - Remove items directly from the cart view with automatic total updates.
- **Dynamic Product Filtering:** Category-based navigation (Mobiles, Tech, Clothes, etc.) to browse specific items.
...
- **CSS3:** Custom styling, Flexbox, and Grid layouts for responsiveness.
- **JavaScript (ES6+):** DOM manipulation for the cart logic, search functionality, and UI interactions.
